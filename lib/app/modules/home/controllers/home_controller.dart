...
class HomeController extends GetxController {
  ...
  // double get startValue => _startValue.value;
  // double get endValue => _endValue.value;
  ...
  // void addtoLike(int id) {

  // }

  // void removeFromLike(int id) {
  ...
  void addStorage(Product listOfLiked) {
    ...
    _storage.write('liked', productListJson);
  }
  ...
  List<Product> getProducts() {
    final List<dynamic>? productListJson = _storage.read('liked');
