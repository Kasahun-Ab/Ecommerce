      ...
      () => Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              CircleAvatar(
                backgroundImage: NetworkImage("https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.befunky.com%2Flearn%2Flinkedin-profile-picture%2F&psig=AOvVaw0tGLIV3SF9PO84Ea-Vr7S4&ust=1721240610472000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCJjes6GXrIcDFQAAAAAdAAAAABAE"),
              ),
              SizedBox(width: 10,),
               Text('${controller.userData!.data.name}',style: GoogleFonts.poppins(color: primary_blue,fontSize: 24,fontWeight: FontWeight.w500),),
            ],
          ),
          leading: IconButton(onPressed: () {  }, icon: Icon(Icons.arrow_back,color: primary_blue,), ),
          actions: [
        ...
        body: ListView(
         ...
         Container(
          ...
          child: Column(
            children: [
              Row(children: [
                InkWell(
                  ...
                  child: Column(
                    children: [
                    Text("Whishlist",style: GoogleFonts.poppins(color: _isWishlistt.isTrue?primary_back:Color(0xff4D4D4D)),),
                                 SizedBox(height: 5,),
                   AnimatedContainer(
                    decoration: BoxDecoration(
                      color: Colors.black,
                      borderRadius:BorderRadius.circular(30)),
                    width : _isWishlistt.isTrue? 65: 0 ,height: 4, duration: Duration(milliseconds: 200),)
                    ],
                  ),
                ),
                   ...
                   child: Column(
                     children: [
                       Text("Free delivery"),
                        ...
                        width :_isWishlistt.isFalse? 65: 0,height: 4,duration: Duration(milliseconds: 200),)
            ...
            SizedBox(height: 10,)
,
            _isWishlistt.isTrue? AnimatedContainer(
        
               width:_isWishlistt.isTrue? MediaQuery.of(context).size.width:0,  
               
               
                height: 150,duration: Duration(milliseconds: 200),
               child: _wishlist.value.data.length==0?Center(child: Text("No Items"),): ListView.builder(
itemCount:_wishlist.value.data.length,
  ...
  children: [
    ClipRRect(
      ...
      child: CachedNetworkImage(
        ...
        height: 100.h,
        width: 120.w,
        imageUrl: _wishlist.value.data[index].product.images.length != 0
            ? _wishlist.value.data[index].product.images[0].mediumimageUrl
    ...
    Positioned(
      ...
      child: InkWell(
        ...
        child: Container(
         width: 30,
         height: 30,
         decoration: BoxDecoration(color: primary_white,borderRadius: BorderRadius.circular(10)),
        child: Center(child: SvgPicture.asset("assets/svg/liked.svg"),),
          ),
      ),
    ),
  ],
  ...
  style: ElevatedButton.styleFrom(
    backgroundColor: const Color.fromARGB(66, 221, 219, 219), // Background color
   // Text color
    ...
    child: Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 5,),
          Image.asset("assets/images/brokerage 1.png")
        ],
      ),
    ),
  ),
